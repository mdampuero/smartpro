...
class Model_DBTable_Branch extends Zend_Db_Table_Abstract {

    protected $_name = 'sg_branch';
    protected $names = 'br_name';
    protected $primary = 'br_id';
    protected $deleted = 'br_deleted';
    protected $status = 'br_status';
    protected $modified = 'br_modified';
    protected $created = 'br_created';
    protected $defultSort = 'br_name';
