...
class Admin_NewsController extends Zend_Controller_Action {
    ...
    var $actions = array();
    var $options = array();
    var $singular = "Accesorio";
    var $plural = "todos los Accesorios";
    var $messageDelete = "¿Esta seguro que desea eliminar este Accesorio?";
    var $title = "Repuestos / Accesorios";
    ...
    public function init() {
        try {
            ...
            $this->fields = array(
                ...
                array('field' => 'ne_title', 'label' => 'Título', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
                array('field' => 'ne_subtitle', 'label' => 'Subtítulo', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
                array('field' => 'ne_picture', 'label' => 'Foto', 'type' => 'image', 'x' => 800, 'y' => 600, 'list' => false, 'width' => "100px"),
                array('field' => 'ne_content', 'label' => 'Descripción', 'search' => true, 'type' => 'textarea','html'=>true,'attr'=>'rows="15"'),
            );
            ...
            $this->model = new Model_DBTable_News();
