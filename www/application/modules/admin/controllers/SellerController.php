...
class Admin_SellerController extends Zend_Controller_Action {

    var $fields = array();
    var $actions = array();
    var $options = array();
    var $singular = "Vendedor";
    var $plural = "todos los Vendedores";
    var $messageDelete = "¿Esta seguro que desea eliminar esta Vendedor?";
    var $title = "Vendedor";
    ...
    public function init() {
        try {
            ...
            //SEND DATE VIEW
            $this->fields = array(
                array('field' => 'se_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
                array('field' => 'se_name', 'label' => 'Nombre Completo', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
                array('field' => 'se_user', 'label' => 'Usuario', 'required' => 'required', 'search' => true),
                array('field' => 'se_pass', 'label' => 'Clave', 'required' => 'required', 'search' => true, 'type' => 'password'),
                array('field' => 'se_email', 'label' => 'E-Mail', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true, 'type' => 'email'),
            );
            ...
            $this->model = new Model_DBTable_Seller();
    ...
    public function addAction() {
        try {
            if ($this->getRequest()->isPost()) {
                ...
                $this->data['se_pass'] = md5($this->data['se_pass']);
