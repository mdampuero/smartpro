...
class Admin_BmodelController extends Zend_Controller_Action {
    ...
    var $title = "Repuestos / Baterías / Medidas";
    ...
    public function init() {
        try {
            ...
            //SEND DATE VIEW
            $this->fields = array(
                array('field' => 'bm_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
                array('field' => 'bm_name', 'label' => 'Nombre', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
//                array('field' => 'bm_size', 'label' => 'Medida', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
            );
            ...
            $this->model = new Model_DBTable_BModel();
