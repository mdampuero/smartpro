...
class Admin_ProviderController extends Zend_Controller_Action {
    ...
    var $actions = array();
    var $options = array();
    var $singular = "Proveedor";
    var $plural = "todos los Proveedores";
    var $messageDelete = "¿Esta seguro que desea eliminar este Proveedor?";
    var $title = "Proveedores";
    ...
    public function init() {
        try {
            ...
            $this->model = new Model_DBTable_Provider();
