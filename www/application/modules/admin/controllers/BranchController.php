...
class Admin_BranchController extends Zend_Controller_Action {
    ...
    var $options = array();
    var $singular = "Marca";
    var $plural = "todas las Marcas";
    var $messageDelete = "¿Esta seguro que desea eliminar esta Marca?";
    var $title = "Vehículos / Marcas";
    ...
    public function init() {
        try {
            ...
            //SEND DATE VIEW
            $this->fields = array(
                array('field' => 'br_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
                array('field' => 'br_name', 'label' => 'Nombre', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
            );
            ...
            $this->model = new Model_DBTable_Branch();
