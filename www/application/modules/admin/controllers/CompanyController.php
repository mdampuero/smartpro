...
class Admin_CompanyController extends Zend_Controller_Action {
    ...
    var $actions = array();
    var $options = array();
    var $singular = "Compañía de Seguro";
    var $plural = "todas las Compañías";
    var $messageDelete = "¿Esta seguro que desea eliminar esta Compañía?";
    var $title = "Compañías de Seguro";
    ...
    public function init() {
        try {
            ...
            //SEND DATE VIEW
            $this->fields = array(
                array('field' => 'co_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
                array('field' => 'co_name', 'label' => 'Nombre', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
                array('field' => 'co_phone', 'label' => 'Teléfono', 'search' => true, 'order' => true, 'list' => false),
                array('field' => 'co_email', 'label' => 'E-Mail', 'search' => true, 'order' => true, 'list' => false),
                array('field' => 'co_user', 'label' => 'Usuario', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
                array('field' => 'co_password', 'label' => 'Contraseña', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
                array('field' => 'co_observation', 'label' => 'Observaciones', 'search' => true, 'type' => 'textarea', 'html'=>false),
            );
    ...
    public function editAction() {
        try {
            if ($this->getRequest()->isPost()) {
                $this->data = $this->_helper->Form->isValid($this->fields);
                if($this->model->isExist($this->data["co_user"],$this->view->parameters["id"]))
                    throw new Zend_Controller_Action_Exception('El usuario '. $this->data["co_user"].' ya existe para otra compañia, por favor elija otro.');
