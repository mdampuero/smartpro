...
class Admin_CmodelController extends Zend_Controller_Action {
    ...
    var $title = "Repuestos / Neumáticos / Modelos";
    ...
    public function init() {
        try {
            ...
            //SEND DATE VIEW
            $this->fields = array(
                array('field' => 'cm_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
                array('field' => 'cm_cb_id', 'label' => 'Marca', 'required' => 'required', 'type' => 'combo', 'data' => $this->cbranch->listAll(), 'option-empy' => 'Seleccione una Marca'),
                array('field' => 'cb_name', 'label' => 'Marca', 'notdisplay' => true, 'notsave' => true, 'list' => true, 'search' => true, 'order' => true),
                array('field' => 'cm_name', 'label' => 'Nombre', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
                array('field' => 'cm_size', 'label' => 'Medida', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
            );
            ...
            $this->model = new Model_DBTable_CModel();
    ...
    public function indexAction() {
        try {
            $this->view->filter = array(
                'cm_cb_id' => array('label' => 'Marca', 'data' => $this->cbranch->showAll(), 'id' => 'cb_id', 'value' => 'cb_name')
            );
            //SAVE MASIVE
