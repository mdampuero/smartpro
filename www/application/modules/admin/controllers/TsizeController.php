...
require_once 'Tsize.php';
require_once 'Tmodel.php';
require_once 'Tbranch.php';
require_once 'Common.php';

class Admin_TsizeController extends Zend_Controller_Action {

    var $fields = array();
    var $actions = array();
    var $options = array();
    var $singular = "Medida";
    var $plural = "todas las Medidas";
    var $messageDelete = "¿Esta seguro que desea eliminar esta Medida?";
    var $title = "Repuestos / LLantas / Medidas";
    ...
    public function init() {
        try {
            ...
            $this->tmodel = new Model_DBTable_Tmodel();
            $this->tbranch = new Model_DBTable_Tbranch();
            //SEND DATE VIEW
            $this->fields = array(
                array('field' => 'ts_id', 'label' => 'ID', 'list' => true, 'class' => 'id', 'order' => true),
                array('field' => 'ts_tb_id', 'label' => 'Marca', 'required' => 'required', 'type' => 'combo', 'data' => $this->tbranch->listAll(), 'option-empy' => 'Seleccione una Marca'),
                array('field' => 'tb_name', 'label' => 'Marca', 'notdisplay' => true, 'notsave' => true, 'list' => true, 'search' => true, 'order' => true),
                array('field' => 'ts_tm_id', 'label' => 'Modelo', 'required' => 'required', 'type' => 'combo', 'data' => $this->tmodel->listAll(), 'option-empy' => 'Seleccione un Modelo'),
                array('field' => 'tm_name', 'label' => 'Modelo', 'notdisplay' => true, 'notsave' => true, 'list' => true, 'search' => true, 'order' => true),
                array('field' => 'ts_name', 'label' => 'Nombre', 'required' => 'required', 'search' => true, 'order' => true, 'list' => true),
            );
            ...
            $this->model = new Model_DBTable_Tsize();
    ...
    public function indexAction() {
        try {
            ...
            $this->view->filter = array(
                'ts_tb_id' => array('label' => 'Marca', 'data' => $this->tbranch->showAll(), 'id' => 'tb_id', 'value' => 'tb_name'),
                'ts_tm_id' => array('label' => 'Modelo', 'data' => $this->tmodel->showAll(), 'id' => 'tm_id', 'value' => 'tm_name')
            );
