...
class Model_DBTable_Tsize extends Zend_Db_Table_Abstract {

    protected $_name = 'sg_tsize';
    protected $names = 'ts_name';
    protected $primary = 'ts_id';
    protected $deleted = 'ts_deleted';
    protected $status = 'ts_status';
    protected $modified = 'ts_modified';
    protected $created = 'ts_created';
    protected $defultSort = 'ts_name';
    ...
    public function showAll($where = null, $sort = null, $order = null) {
        ...
        $select->joinLeft("sg_tmodel as tm", "tm.tm_id=" . $this->_name . ".ts_tm_id");
        $select->joinLeft("sg_tbranch as tb", "tb.tb_id=" . $this->_name . ".ts_tb_id");
        $select->where($where);
